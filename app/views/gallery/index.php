...
<head>
    ...
    <title>Gallery | K-ZOO</title>
    <style>
        html{
            font-family: Arial, Helvetica, sans-serif;
        }
        .cover{
            background-image: url('http://localhost/mvc_kzoo/public/img/Login-Page1.jpg');
...
<body>
    <div class="cover">
        ...
        <div class="galeri">
            <ul>
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/african_lion.jpg" alt="Gambar Kosong">
                    </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/alpaca.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Alpaca</h4>
                        </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/cheetah.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Cheetah</h4>
                        </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/giant_panda.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Giant Panda</h4>
                        </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/bufflehead.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Bufflehead</h4>
                        </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/gray_wolf.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Gray Wolf</h4>
                        </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/orangutan.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Orangutan</h4>
                        </div>
                ...
                <li>
                    <div class="kotak_gambar">
                        <img src="<?php echo BASEURL;?>/Animals-Gallery/fennec_fox.jpg" alt="Gambar Kosong">
                    </div>
                        <div class="text-hewan">
                            <h4>Fennec Fox</h4>
                        </div>
