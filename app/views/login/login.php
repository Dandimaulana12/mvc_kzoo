...
<head>
    ...
    <title>Login or Sign Up | K-ZOO</title>
    <style>
        html{
                ...
                <form action="<?= BASEURL;?>/login/masuk" method="POST">
                    ...
                    <div data-aos="fade-up"
                        ...
                        <div class="kotak_submit">
                            <button type="submit" class="submit_log">LOGIN</button>
                        </div>
                        <br>
                        <div class="signup">
                            OR
