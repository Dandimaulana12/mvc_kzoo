...
<head>
    ...
    <style>
        ...
        .cover{
            background-image: url('img/Login-Sign-Up.jpg');
    ...
    <div class="cover">
         ...
         <div class="nav">
            <ul>
                ...
                <li><a href="#">TICKETS</a>
                    <ul class="dropdown">
                        <li><a href="<?= BASEURL;?>/ticket/pesan">Pembelian Ticket</a></li>
        ...
        <form action="user_insert.php" method="POST">
            <div data-aos="fade-left">
                <div class="kotak_username">
                    ...
                    <input type="text" name="full_name" class="inp_email">
                </div>
            </div>
            <br>
            <br>
            <div data-aos="flip-left">
                <div class="kotak_username">
                    ...
                    <input type="text" name="username" class="inp_username">
                </div>
            </div>
            <br>
            <div data-aos="flip-left">
            ...
            <div data-aos="zoom-in">
                <div class="kotak_password">
                    ...
                    <input type="password" name="password" class="inp_password" id="input_pw">
                </div>
            </div>
            <div data-aos="zoom-in-down">
                <table  class="kotak_box">
                    ...
                    <input type="checkbox" class="kotak_terima" style="z-index:20px;" id="setuju" name="setuju">
                    </td>
                    <td class="default-text-box"><label class="terima_text" for="setuju" >I have read and agree to the Term and Conditions</label></td>
                    </tr>
                </table>
            </div>
            <div>
                <div class="kotak_submit">
                <button type="submit" class="submit_log" id="button">SIGN UP</button>
            </div>
            </div>
